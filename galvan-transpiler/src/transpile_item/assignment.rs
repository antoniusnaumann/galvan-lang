...
use crate::Transpile;
use galvan_ast::{Assignment, AssignmentOperator, AssignmentSource, AssignmentTarget, Ownership};
...
impl_transpile_variants!(AssignmentSource; Expression, ElseExpression);
